...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Una increible herramienta que te permitirá calcular de manera detallada tus viajes de Uber de una forma fácil y segura">
        ...
        <div class="row">
            <div class="col-sm-12 col-md12 col-lg-12">
                <div class="thumbnail center">
                    <div class="horizontal-center"><h1>Calcular viaje detallado</h1></div>
                    <div class="caption">
