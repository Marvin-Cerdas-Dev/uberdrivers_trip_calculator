...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Podras saber cuales son las zonas de covertura de Uber en Costa Rica, Además aquí podras verificar tus viajes de la plataforma Uber de una forma fácil y segura">
        <meta name="keywords" content="UberCalc, Calculadora, Viajes, Uber, Calcular Viaje, Calculadora de viajes, Viajes de Uber, calculadora uber, calculador de tarifas uber, calcular precio uber, calcular tarifa uber, uber calcular precio, calcular uber, calcular viaje uber, Covertura, Provincias, San José, Heredia, Alajuela, Cartago, Putarenas, Limón">
        ...
        <!-- Title -->
        <title>UberCalc - Cobertura del servicio de Uber</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card md-3 card-update">
                <img src="img/coverage.png" class="card-img-top" alt="Cobertura de servicios de Uber en tu ciudad">
                <div class="card-body">
                    <h1 class="card-title">Cobertura del servicio de uber</h1>
                    <p class="card-text">
                        Desde el noviembre del 2019 que Uber inició operaciones su cobertura está en:
                    <ul>
                        <li>Gran Área Metropolitana</li>
                        <ul>
                            <li>San José</li>
                            <li>Heredia</li>
                            <li>Alajuela</li>
