...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Una maravillosa herramienta que te permitirá calcular de manera simple tus viajes de la plataforma Uber de una forma fácil y segura">
        ...
        <!-- Title -->
        <title>UberCalc - Calculadora simple</title>
        ...
        <div class="row">
            <div class="col-sm-12 col-md12 col-lg-12">
                <div class="thumbnail center">
                    <div class="horizontal-center"><h1>Calcular viaje simple</h1></div>
                    <div class="caption">
