...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Te explicamos en que forma deberás proceder si tienes una emergencia durante un viaje de Uber, Además aquí podras verificar tus viajes de la plataforma Uber de una forma fácil y segura">
        ...
        <!-- Title -->
        <title>UberCalc - Ayuda en caso de emergencia</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card md-3 card-update">
                <img src="img/help.png" class="card-img-top" alt="Ayuda">
                <div class="card-body">
                    <H1 class="card-title">Ayuda</H1>
                    <p class="card-text">
                        Si tienes un accidente, Uber recomienda que lo primero que debes realizar es, llamar a las autoridades pertinentes. Entiendase por autoridades pertinentes policia, oficial de tránsito, Cruz Roja, OIJ o bomberos, dependiendo la situación presentada. Es muy importante denotar que, esto es de carácter fundamental para la plataforma. Para ello puedes llamar al numero de emegerncia:
                    </p>
                    <p class="card-text">
                    ...
                    <p class="card-text">
                        Además, es importante que te contactes con el grupo de Telegram que tiene Uber. En el mismo te estanran respondiento tan pronto sea posible.
                    </p>
                    <p class="card-text">
                        <a href="tel:+5068531-7036" class="btn btn-update" hreflang="es"><b>Grupo de Telegram</b></a>
                    </p>
                </div>
            </div>
        </div>
